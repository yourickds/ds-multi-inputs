...
// const nunjucksRender = require('gulp-nunjucks-render'); // Подключаем шаблонизатор
...
function styles() {
	return src('src/css/*.css') // Выбираем источник
	// .pipe(sass())
...
function startwatch() {
	...
	watch('app/templates/**/*.html').on('change', series(renderHtml, browserSync.reload));
...
exports.default = parallel(styles, renderHtml, scripts, browsersync, startwatch);